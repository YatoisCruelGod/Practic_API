...
namespace Practic_API
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            app.UseCors(builder => builder.WithOrigins(new[] {"https://localhost:7242", "http://localhost:5000", "https://practic-api.onrender.com", "https://practic-api.onrender.com/api/profiles"})
            .AllowAnyHeader()
            .AllowAnyMethod());
